...
private:
	...
	glm::vec3 _attenuation;			// 衰减因子，x,y,z 分别对应 常数衰减因子, 距离衰减因子, 二次函数衰减因子
...
public:
	...
	void SetAttenuationFactors(glm::vec3 attenuationFactors);
	void SetAttenuationFactors(GLfloat constantFactor, GLfloat linearFactor, GLfloat quadraticFactor);
